function [x] = inexact_alm_cnnm_1D(y, g,  n, lambda, display)
...
%% parameters:
% y -- m x 1 vector of observations (required input),with the missing entries being filled with zero (required input) 
...
obsrate = sum(g>0.5)/n;
mu = obsrate/fnorm; 
rho = 1.2; % set this to 1.05 if want very accurate solution
